...
output_file1 ='output_file_liver.txt';
...
filenameI0='Patient01.mha';
filenameI1='Patient04.mha';

[I1,I2] = read3DImage_liverCT(filenameI0,filenameI1);
...
for multilev = 0:1:param.maxlevel-1
    ...
    while (abs(RS_final-RS_initial)>tol && iterct_level < itermax)
        ...
        if(plotImage==1 && saveImage == 1)
            PlotImage_liver(iterct,I1_in,I2_in,Iplot);
            save('I1_liver.mat','I1');
            save('Iplot_liver.mat','Iplot');
        end
